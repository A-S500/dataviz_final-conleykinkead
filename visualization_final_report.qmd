...
I love nail polish. I love the colors, the finishes, the little glass bottles that I can display and organize. I love talking about nails, collecting nail polish, giving myself manicures, and mostly importantly, carrying joy with me everywhere I go (all I need to do is look down at my hands and see what makes me happy!)
    ...
    :::  {layout-ncol=2}
    ![Proudly snapping a photo of my collection in 2019](images/IMG_9417.JPG)

    ![Curing a layer of my NYE manicure in 2022](images/IMG_1645.JPEG)
    :::
...
{layout-ncol=2} ![Proudly snapping a photo of my collection in 2019](images/IMG_9417.JPG){fig-align="right" width="400"}![Curing a layer of my NYE manicure in 2022](images/IMG_1645.JPEG){alt="Curing a layer of my NYE day manicure, 2022" fig-align="right" width="400"}
...
nailpolish |>
  ...
  labs(
    y = "",
    x = "",
    title = "polishes by color family") +
...
# need to move up x markers and extend axis slightly, and move title down slightly
```
...
```{r}
ggplot(nailpolish, aes(color_family, year_acquired, color = color_hex)) + 
  geom_jitter() +

...
ggplot(nailpolish, aes(x = color_family, y = reorder(brand, desc(brand)), fill = color_family)) + 
  ...
  labs(
    ...
    theme(panel.background = element_rect(fill = "gray94"),
        ...
        axis.ticks = element_blank(),
        axis.text.y = element_text(size = 10, color = "gray20"),
        axis.title.x = element_text(size = 10, color = "gray20"),
...
-   I could not change the font using showtext. I repeatedly got the following error: `Error in grid.Call(C_textBounds, as.graphicsAnnot(x$label), x$x, x$y, : polygon edge not found`. The internet tells me this can be a common issue. Hopefully I can get this working in the future.
